import { FIFA_2026_GROUPS } from './fifa2026';
...
const MUNDIAL_GROUPS = Object.keys(FIFA_2026_GROUPS);

/**
 * Calcula la tabla predicha de cada grupo del Mundial 2026 a partir de las
 * predicciones del usuario en los partidos de fase de grupos.
...
export function computeGroupStandings(matches: MatchLike[]): GroupStanding[] {
  const byGroup = new Map<string, MatchLike[]>();
